...
type ReleaseMcpServerRequest struct {
	...
	ResourceSpecification *McpResourceSpecification `protobuf:"bytes,8,opt,name=resourceSpecification,proto3" json:"resourceSpecification,omitempty"`
...
const file_ai_ai_request_proto_rawDesc = "" +
	...
	"\vsetAsLatest\x18\x06 \x01(\bR\vsetAsLatest\"\xd2\x03\n" +
	...
	"\x15resourceSpecification\x18\b \x01(\v2\".nacos.ai.McpResourceSpecificationR\x15resourceSpecification\x12O\n" +
